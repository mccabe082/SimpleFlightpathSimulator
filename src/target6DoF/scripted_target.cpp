...
Orientation ScriptedTarget::orientation() const
{
	return _orientation;
}

void ScriptedTarget::setOrientation(const Orientation& o)
{
	_orientation.set(o);
}
...
Velocity ScriptedTarget::velocity() const
{
	return _velocity;
}

void ScriptedTarget::setVelocity(const Velocity& v)
{
	_velocity.set(v);
}
...
Rotation ScriptedTarget::rotation() const
{
	return _rotation;
}

void ScriptedTarget::setRotation(const Rotation& r)
{
	_rotation.set(r);
}
